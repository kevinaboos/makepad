...
impl DrawText {
    ...
    pub fn draw_walk_resumable_with(
        ...
        // Fast path: callers here need the bounds of each laid out row, not the
        // general selection machinery. Walking rows directly avoids the extra
        // grapheme/index work in `selection_rects()` on every repaint.
